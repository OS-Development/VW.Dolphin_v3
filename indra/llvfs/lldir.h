...
// pure virtual functions
	...
	virtual void setPerAccountChatLogsDir(const std::string &grid, const std::string &username);	// Set the per user chat log directory.
	virtual void setLindenUserDir(const std::string &grid, const std::string &username);	// Set the linden user dir to this user's dir
