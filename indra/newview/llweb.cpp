										  ...
										  const LLSD &default_subs)
{
	...
	if(LLGridManager::getInstance()->getGridLabel()=="Second Life")
	{
		substitution["GRID"] = "Agni";
		substitution["GRID_LOWERCASE"] = "agni";
	} else if (LLGridManager::getInstance()->getGridLabel()=="Second Life Beta")
	{
		substitution["GRID"] = "Aditi";
		substitution["GRID_LOWERCASE"] = "aditi";
	}
