...
class LLFileTakeSnapshotToDisk : public view_listener_t
{
	bool handleEvent(const LLSD& userdata)
	{
									   ...
									   FALSE))
		{
			...
			switch(LLFloaterSnapshot::ESnapshotFormat(gSavedSettings.getS32("Snapshot2DiskFormat")))
			{
			  case LLFloaterSnapshot::SNAPSHOT_FORMAT_JPEG:
				formatted = new LLImageJPEG(gSavedSettings.getS32("Snapshot2DiskQuality"));
				break;
