...
#include "lcfloatermachinimatoolbox.h"
...
// [/SL:KB]
	...
	// DV3 - Machinima toolbox
	LLFloaterReg::add("machinima_toolbox", "floater_machinima.xml", (LLFloaterBuildFunc)&LLFloaterReg::build<LCFloaterMachinimaToolbox>);
	// DV3 - Machinima toolbox
	// *NOTE: Please keep these alphabetized for easier merges
