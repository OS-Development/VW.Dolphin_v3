...
//LC
	mCheckHighLightSelection		= getChild<LLCheckBoxCtrl>("checkbox highlight selection");
	getChild<LLUICtrl>("checkbox highlight selection")->setValue((BOOL)gSavedSettings.getBOOL("RenderHighlightSelections"));
	mCheckPivotOnRoot		= getChild<LLCheckBoxCtrl>("checkbox pivot on root");
	getChild<LLUICtrl>("checkbox pivot on root")->setValue((BOOL)gSavedSettings.getBOOL("FSBuildPrefs_ActualRoot"));
//lc	
	//
	// Create Buttons
	//
...
//mk
//LC
	mCheckHighLightSelection(NULL),
	mCheckPivotOnRoot(NULL),
//lc
...
//mk
	...
	if (mCheckHighLightSelection) mCheckHighLightSelection->setVisible( edit_visible );
	if (mCheckPivotOnRoot) mCheckPivotOnRoot->setVisible( edit_visible );
