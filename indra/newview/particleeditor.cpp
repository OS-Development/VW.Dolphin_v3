...
#include "llinventoryfunctions.h"	// for ROOT_DOLPHIN3_FOLDER
...
void ParticleEditor::onInjectButtonClicked()
{
	...
	categoryID=gInventory.findCategoryByName(ROOT_DOLPHIN3_FOLDER);

	// if no #Firestorm folder was found, create one
	if(categoryID.isNull())
		categoryID=gInventory.createNewCategory(gInventory.getRootFolderID(),LLFolderType::FT_NONE,ROOT_DOLPHIN3_FOLDER);
