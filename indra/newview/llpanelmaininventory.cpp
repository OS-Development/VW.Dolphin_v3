...
BOOL LLPanelMainInventory::postBuild()
{
	...
	{
		mQuickFilterCombo->setCommitCallback(boost::bind(&LLPanelMainInventory::onQuickFilterCommit, this, _1));
	}
...
//static
void LLPanelMainInventory::onQuickFilterCommit(LLUICtrl* ctrl)
{
...
void LLPanelMainInventory::refreshQuickFilter(LLUICtrl* ctrl)
{
	...
	U32 filter_type = view->getPanel()->getFilterObjectTypes();
...
void LLPanelMainInventory::onResetAll(void* userdata)
{
	...
	self->onFilterEdit("");
	self->mActivePanel->getRootFolder()->closeAllFolders();
}
...
void LLPanelMainInventory::onExpandAll(void* userdata)
{
	...
	self->mActivePanel->getRootFolder()->openAllFolders();
}
