...
re_map['indra/newview/English.lproj/InfoPlist.strings'] = \
    (('CFBundleShortVersionString = "Dolphin Viewer 3 version [0-9.]+";',
      'CFBundleShortVersionString = "Dolphin Viewer 3 version %(VER_MAJOR)s.%(VER_MINOR)s.%(VER_PATCH)s.%(VER_BUILD)s";'),
     ('CFBundleGetInfoString = "Dolphin Viewer 3 version [0-9.]+',
      'CFBundleGetInfoString = "Dolphin Viewer 3 version %(VER_MAJOR)s.%(VER_MINOR)s.%(VER_PATCH)s.%(VER_BUILD)s'))

re_map['indra/newview/RRInterface.h'] = \
    (('#define RR_SLV_VERSION "The Dolphin Viewer 3 - [0-9.]+";',
      '#define RR_SLV_VERSION "The Dolphin Viewer 3 - %(VER_MAJOR)s.%(VER_MINOR)s.%(VER_PATCH)s.%(VER_BUILD)s"'),
     ('#define RR_SLV_VERSION "The Dolphin Viewer 3 - [0-9.]+"',
      '#define RR_SLV_VERSION "The Dolphin Viewer 3 - %(VER_MAJOR)s.%(VER_MINOR)s.%(VER_PATCH)s.%(VER_BUILD)s"'))
    ...
    if new_version:
        ...
        if llversion.using_hg():
            if new_revision:
                ...
                revision = str(int(llversion.get_hg_changeset())+1)
